...
function buildRow(item = {}) {
  ...
  tr.innerHTML = `
    ...
    <td class="col-desc"><input type="text" data-role="desc" value="${escHtml(desc)}" placeholder="Description" oninput="recalcRow(this)"></td>
    <td class="col-qty"><input type="number" data-role="qty" value="${qty}" min="0" step="any" oninput="recalcRow(this)"></td>
    <td class="col-rate"><input type="number" data-role="rate" value="${rate}" min="0" step="0.01" placeholder="0.00" oninput="recalcRow(this)"></td>
    <td class="col-total" data-role="total">${fmtMoney(lineTotal)}</td>
